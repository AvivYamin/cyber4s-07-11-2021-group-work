...
/***/ "./src/helpers/search/filer.js":
/*!*************************************!*\
  !*** ./src/helpers/search/filer.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"searchMycontact\": () => (/* binding */ searchMycontact)\n/* harmony export */ });\nfunction searchMycontact(query, phoneBook){\n    let indicator = -1;\n    for(let i = 0; i < phoneBook.length; i++){\n        if(phoneBook[i].name == query || phoneBook[i].id == query || phoneBook[i].number == query){\n            indicator = i;\n        }\n    }\n    return indicator;\n}\n\n//# sourceURL=webpack://backend/./src/helpers/search/filer.js?");
